<?php
	 ...
	 * ### Переключение языка ###
	 *
	 * Устанавливаем какие языки может поддерживать сайт.
	 * 
	 * Проверяем cookies на существования выбранного языка,
	 * если не существует - сохранить выбранный.
	 * 
	 * Если приходит запрос, на не существующий(не поддерживаемый) язык,
	 * то устанавливаем язык по умолчанию 'ru'
	 *
	 */
